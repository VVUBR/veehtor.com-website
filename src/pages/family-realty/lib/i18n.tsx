...
const DICT: Record<string, { pt: string; en: string }> = {
  ...
  tab_profit: { pt: "Lucro", en: "Profit" },

  // profit tab
  profit_custo_total: { pt: "Custo total", en: "Total cost" },
  profit_preco_venda: { pt: "Preço de venda", en: "Sale price" },
  profit_lucro: { pt: "Lucro", en: "Profit" },
  profit_margem: { pt: "Margem líquida", en: "Net margin" },
  profit_sec_cost: { pt: "Custo", en: "Cost" },
  profit_obra_realizado: { pt: "Obra realizado", en: "Construction actual" },
  profit_comprometido: { pt: "Comprometido em contratos", en: "Committed in contracts" },
  profit_budget_a_gastar: { pt: "Budget a gastar", en: "Budget remaining" },
  profit_obra_projetada: { pt: "Obra projetada", en: "Projected construction" },
  profit_bank_fee: { pt: "Custo bancário", en: "Bank fee" },
  profit_acquisition: { pt: "Aquisição", en: "Acquisition" },
  profit_custo_sqft_obra: { pt: "Custo obra / sqft", en: "Construction cost / sqft" },
  profit_custo_sqft_total: { pt: "Custo total / sqft", en: "Total cost / sqft" },
  profit_sec_sale: { pt: "Venda e resultado", en: "Sale and result" },
  profit_price_actual: { pt: "Preço de venda (realizado)", en: "Sale price (actual)" },
  profit_price_expected: { pt: "Preço de venda (previsto)", en: "Sale price (expected)" },
  profit_preco_sqft: { pt: "Preço / sqft", en: "Price / sqft" },
  profit_comissao: { pt: "Comissão", en: "Commission" },
  profit_selling_costs: { pt: "Custos de venda", en: "Selling costs" },
  profit_receita_liquida: { pt: "Receita líquida", en: "Net revenue" },
  profit_roi: { pt: "ROI", en: "ROI" },
  profit_sec_investor: { pt: "Investidor", en: "Investor" },
  profit_inv_capital: { pt: "Capital do investidor", en: "Investor capital" },
  profit_inv_pct: { pt: "Participação", en: "Profit share" },
  profit_inv_profit: { pt: "Lucro do investidor", en: "Investor profit" },
  profit_inv_roi: { pt: "ROI do investidor", en: "Investor ROI" },
  profit_inv_annual: { pt: "Retorno anual", en: "Annualized return" },
  profit_no_sale: { pt: "Os dados de venda desta obra ainda não foram preenchidos na aba Sale da planilha.", en: "Sale data for this job has not been filled in on the Sale tab of the spreadsheet yet." },
  profit_no_data: { pt: "Nenhuma obra com dados de venda preenchidos ainda.", en: "No jobs with sale data filled in yet." },
 ...
 kpi_post_sale: { pt: "Pós-venda", en: "Post-sale" },
 kpi_post_sale_sub: { pt: "garantia e reparos após a venda", en: "warranty and repairs after sale" },
  ...
  th_billed: { pt: "Cobrado", en: "Billed" },
  th_paid: { pt: "Pago", en: "Paid" },
  th_open: { pt: "Em aberto", en: "Open" },
  evb_faturas: { pt: "Faturas", en: "Invoices" },
  evb_pagamentos: { pt: "Pagamentos", en: "Payments" },
  evb_pago_total: { pt: "Pago total", en: "Total paid" },
  evb_recibo_auto: { pt: "Recibo/baixa automática", en: "Auto receipt" },
  evb_pag_manual: { pt: "Pagamento manual", en: "Manual payment" },
  evb_pag_manual_sf: { pt: "Pagamento manual (sem fatura)", en: "Manual payment (no invoice)" },
  evb_unlinked_note: {
    pt: "inclui {v} em pagamentos não vinculados a uma fatura específica",
    en: "includes {v} in payments not linked to a specific invoice",
  },
  evb_faltam: { pt: "faltam {v}", en: "{v} remaining" },
  evb_marcar_status_tip: {
