...
const Privacy = () => {
  ...
  const { privacy: P, legalCommon: LC } = useSiteContent();
      ...
      <div className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <article className="prose prose-slate max-w-none">
          ...
          <div className="space-y-8">
            <section>
              {P.intro.map((p, i) => <p key={i}>{p}</p>)}
              <p className="text-sm italic text-muted-foreground">
                <strong>{P.disclaimer.split(":")[0]}:</strong>{P.disclaimer.slice(P.disclaimer.indexOf(":") + 1)}
              </p>
            </section>
